...
const Footer = () => {
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form action="#" className="space-y-8">
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white-300 rounded-lg bg-orange-500 sm:w-fit">Send message</button>
      </form>
  </div>
</section>
        <div className="justify-center items-start inline-flex ">
          <div className="flex mt-2 mb-8 -mx-2">
            ...
            <div className="mx-2  rounded-full items-center justify-center flex p-2">
              ©{new Date().getFullYear()} - Dafna Consult
            </div>
          </div>
        </div>
      </div>
